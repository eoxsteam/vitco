...
class LeadScoringFrequency(models.Model):
    _name = 'vrm.lead.scoring.frequency'
...
class FrequencyField(models.Model):
    _name = 'vrm.lead.scoring.frequency.field'
    ...
    field_id = fields.Many2one('ir.model.fields', domain=[('model_id.model', '=', 'vrm.lead')], required=True)
